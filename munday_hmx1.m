...
chosen
bvec_n=0.5*chosen(1:3); %unit burgers vector / slip direction
lvec=chosen(4:6);
...
fprintf(' Voigt Avg Properties: Ev=%6.2f, nuv=%6.2f, Gv=%6.2f , Bv=%6.2f \n',Ev,nuv,Gv,Bv)
fprintf(' Reuss Avg Properties: Er=%6.2f, nur=%6.2f, Gr=%6.2f , Br=%6.2f \n',Er,nur,Gr,Br)
%--------------------------------------------------------------------------
% get fourth order C
C=zeros(3,3,3,3);
for i=1:3
